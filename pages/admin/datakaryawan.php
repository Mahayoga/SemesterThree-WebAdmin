            ...
            <tbody>
              <tr>
                ...
                <td class="align-middle text-center text-sm">
                  <span class="badge badge-sm bg-gradient-success">0853157368</span>
                </td>
                <td class="align-middle text-center">
                  <span class="text-secondary text-xs font-weight-bold">Probolinggo</span>
                </td>
              ...
              <tr>
                ...
                <td>
                  <p class="text-xs font-weight-bold mb-0">Nissa</p>
       
                </td>
                <td class="align-middle text-center text-sm">
                  <span class="badge badge-sm bg-gradient-success">081383452985</span>
                </td>
                <td class="align-middle text-center">
                  <span class="text-secondary text-xs font-weight-bold">Banyuwangi</span>
                </td>
                <td class="align-middle">
                  <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                  <td>
              ...
              <tr>
                ...
                <td>
                  <p class="text-xs font-weight-bold mb-0">Filla</p>

                </td>
                <td class="align-middle text-center text-sm">
                  <span class="badge badge-sm bg-gradient-success">0843525762</span>
                </td>
                <td class="align-middle text-center">
                  <span class="text-secondary text-xs font-weight-bold">Sumatera</span>
                </td>
                <td class="align-middle">
                  <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                  <td>
              ...
              <tr>
                ...
                <td class="align-middle text-center text-sm">
                  <span class="badge badge-sm bg-gradient-success">0886482623</span>
                </td>
                <td class="align-middle text-center">
                  <span class="text-secondary text-xs font-weight-bold">Gresik</span>
                </td>
                <td class="align-middle">
                  <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                  <td>
              ...
              <tr>
                ...
                <td>
                  <p class="text-xs font-weight-bold mb-0">Samsul</p>

                </td>
                <td class="align-middle text-center text-sm">
                  <span class="badge badge-sm bg-gradient-success">0874379732</span>
                </td>
                <td class="align-middle text-center">
                  <span class="text-secondary text-xs font-weight-bold">Jember</span>
                </td>
